...
#Модель самого магазина, есть заглавие, имя магазина, описание, стоимость, фотография,
# и дата публикации. Дал дефолтное значение в заглавии, дефолтное значение в описании
...
class Category(models.Model):
    ...
    def __str__(self):
        return f'ID {self.id}: {self.category_id}'
